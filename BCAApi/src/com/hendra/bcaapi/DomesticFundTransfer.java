...
public class DomesticFundTransfer {
    ...
    public DomesticFundTransfer(APIOAuthToken accessToken, Signature signature, String channelId, String credentialId) throws Exception {
        ...
        this.header.put("Origin", "example.com");
        ...
        if (httpRequest.getResponseCode() == 200) {
            ...
            this.transactionId = (String) obj.get("TransactionID");
            this.transactionDate = (String) obj.get("TransactionDate");
            this.fillerPPUNo = (String) obj.get("filler_ppu_no"); //LLG/RTGS only, return null if not exists
        }
        else
